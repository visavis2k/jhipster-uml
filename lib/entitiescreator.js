...
var EntitiesCreator = module.exports = function(xmiParser, listDTO) {
  if(!xmiParser) {
...
EntitiesCreator.prototype.checkNoSQLModeling = function(){
  if(types_helper.isNoSQL(this.databaseTypes)
    ...
    throw new NoSQLModellingException(
...
function NoSQLModellingException(message) {
  this.name = 'NoSQLModellingException';
  this.message = (message || '');
}
NoSQLModellingException.prototype = new Error();
